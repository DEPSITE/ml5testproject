...
<div>
  <h3>과제 필요성</h3>
  <h4>
    최근에는 VR시장이 점점 커지고 있고 여러가지 움직임을 최대한 잘 인식할 수 있도록 발전해가고 있다.<br>
    그렇지만 정작 VR 안에서 무언가를 줍거나 할 때에는 실제로 손가락으로 물건을 잡기 보다는 손에 쥔 컨트롤러의<br>
    버튼을 누르는 식이다. 그런 부분에서 이러한 연구가 깊게 진행된다면 컨트롤러를 내려놓고 직접 손으로<br> 
    VR속의 물건을 집는 식으로 이용 가능하지 않을까 생각해 본다.
  </h4>
</div>
<br>
<div>
