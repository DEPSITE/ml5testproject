...
<div>
  <h3>과제 필요성</h3>
  <h4>
    사람들이 많이 사용하는 컨트롤러는 장시간 들고 있는 것으로 인해 사용자들에게 통증과 같은 많은 문제를 일으킨다.<br>
    이러한 사용자들의 고통을 줄이기 위해서 무게가 있는 컨트롤러를 사용하지 않고 손동작 인식과 같이<br>
    딥러닝을 이용하여 컨트롤러 없이 조작을 할 수 있도록 이 과제가 필요할 수도 있다.
  </h4>
</div>
<br>
<div>
